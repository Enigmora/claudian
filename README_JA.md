...
<p align="center">
  <a href="https://obsidian.md">
    <img src="https://img.shields.io/badge/Obsidian-プラグイン-7C3AED?style=flat-square&logo=obsidian&logoColor=white" alt="Obsidianプラグイン">
  </a>
  ...
  <a href="LICENSE">
    <img src="https://img.shields.io/badge/ライセンス-MIT-green?style=flat-square" alt="MITライセンス">
  </a>
</p>
...
- **ローカルストレージ**: APIキーはデバイスにのみ保存されます
- **テレメトリなし**: 使用データを収集しません
- **オープンソース**: 100%監査可能なコード
